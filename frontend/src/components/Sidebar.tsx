...
const ITEMS: Array<{ id: Route["name"]; label: string; glyph: string }> = [
  ...
  { id: "sinais",     label: "Sinais de atenção", glyph: "◆" },
  { id: "quizzes",    label: "Quizzes",           glyph: "Q" },
  { id: "simulador",  label: "Radar de Conduta",         glyph: "R" },
  { id: "chat",       label: "Chat orientativo",  glyph: "C" },
  { id: "canais",     label: "Você não está só",   glyph: "!" },
  ...
  return (
    <aside className="sidebar">
      <div className="sb-brand">
        ...
        <span>Byst<span style={{ color: "var(--accent)" }}>.</span>end</span>

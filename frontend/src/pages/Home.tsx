  ...
  return (
    <div className="page-enter">
      ...
      <div className="doors">
        ...
        <button className="door conversar" onClick={openChat}>
      ...
      <div className="stats">
        ...
        <div className="stat">
          <div className="k">Quizzes</div>
          <div className="v">{progress.quizzesFeitos.length}</div>
          <div className="sub">explorados neste navegador</div>
        </div>
        <div className="stat">
